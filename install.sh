...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/asas-dev-web/checkany/main/chany > /dev/null 2>&1
wget https://raw.githubusercontent.com/asas-dev-web/checkany/main/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/asas-dev-web/checkany/main/checkany.py > /dev/null 2>&1
